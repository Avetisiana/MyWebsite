  ...
  const bodyHTML = `<div class="container">
    <div class="legal-page devis-page">
      ...
      <div class="devis-doc">
        ...
        <p class="devis-note">Conditions fiscales précisées sur le devis définitif. Hébergement géré facturé séparément dès ${content.configurator.hosting.display}, avec renouvellement annuel. Option Maintenance (modifications & support) : suivi du bon fonctionnement, assistance et jusqu’à 30 minutes de modifications légères par mois à 79&nbsp;€/mois, non cumulables et sans engagement de durée.</p>
        ...
        <ul>
          ...
          <li>Hébergement géré dès ${content.configurator.hosting.display}, renouvelé annuellement et sans contrat de maintenance obligatoire — le nom de domaine reste à votre nom.</li>
        </ul>
      </div>
