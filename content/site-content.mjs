...
export const content = {
  ...
  configurator: {
    ...
    optionsLabel: 'Personnalisez votre projet',
    optionGroups: [
      {
        id: 'contenu',
        label: 'Contenu & autonomie',
        intro: 'Pour préparer vos contenus et garder la main après la livraison.',
        options: [
          {
            id: 'administration',
            name: 'Espace d’administration standard',
            desc: 'Modification autonome des textes et images.',
            price: 690,
            pricePrefix: 'dès',
          },
          {
            id: 'reecriture',
            name: 'Réécriture & optimisation',
            desc: 'Jusqu’à 5 pages à partir de vos textes.',
            price: 390,
            exclusiveGroup: 'textes',
          },
          {
            id: 'redaction',
            name: 'Rédaction complète',
            desc: 'Jusqu’à 5 pages à partir d’un entretien.',
            price: 690,
            pricePrefix: 'dès',
            exclusiveGroup: 'textes',
          },
          {
            id: 'pages',
            name: '3 pages simples supplémentaires',
            desc: 'Dans la structure graphique déjà définie.',
            price: 450,
          },
          {
            id: 'langue',
            name: 'Langue supplémentaire',
            desc: 'Traductions fournies · 30 % de la formule, minimum 490 €.',
            rate: 0.3,
            minPrice: 490,
          },
        ],
      ...
      {
        id: 'conversion',
        label: 'Visibilité & conversion',
        intro: 'Pour être trouvé plus facilement et transformer davantage de visites en demandes.',
        options: [
          {
            id: 'visibilite-locale',
            name: 'Pack visibilité locale',
            desc: 'Mots-clés, 5 pages optimisées, Search Console et fiche Google.',
            price: 590,
          },
          {
            id: 'rdv',
            name: 'Prise de rendez-vous en ligne',
            desc: 'Intégration d’un outil existant.',
            price: 290,
            pricePrefix: 'dès',
          },
          {
            id: 'galerie',
            name: 'Galerie ou portfolio avancé',
            desc: 'Présentation organisée, filtres simples et agrandissement.',
            price: 290,
          },
          {
            id: 'simulateur',
            name: 'Formulaire avancé ou simulateur',
            desc: 'Parcours en plusieurs étapes et demande qualifiée.',
            price: 590,
            pricePrefix: 'dès',
          },
          {
            id: 'automatisation',
            name: 'CRM, newsletter ou automatisation',
            desc: 'Connexion à un outil et scénario simple.',
            price: 390,
            pricePrefix: 'dès',
          },
          {
            id: 'paiement',
            name: 'Paiement ou acompte en ligne',
            desc: 'Intégration d’une solution de paiement existante.',
            price: 390,
            pricePrefix: 'dès',
          },
          {
            id: 'conversions',
            name: 'Mesure des conversions',
            desc: 'Suivi des formulaires, clics d’appel et prises de rendez-vous.',
            price: 190,
          },
        ],
      },
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'Un espace d’administration standard peut être ajouté à partir de 690 € si vous souhaitez modifier vous-même vos textes et images. Le tarif est adapté lorsque le site comprend un blog ou des contenus plus complexes.',
      },
      {
